...
TF_LITE_MICRO_TEST(TestAudioProviderMock) {
  ...
  TfLiteStatus get_status =
      GetAudioSamples(0, kFeatureSliceDurationMs,
  ...
  get_status =
      GetAudioSamples(500, kFeatureSliceDurationMs,
                      &audio_samples_size, &audio_samples);
  TF_LITE_MICRO_EXPECT_EQ(kTfLiteOk, get_status);
  TF_LITE_MICRO_EXPECT_LE(audio_samples_size, kMaxAudioSampleSize);
  TF_LITE_MICRO_EXPECT(audio_samples != nullptr);
  ...
  get_status =
      GetAudioSamples(1500, kFeatureSliceDurationMs,
                      &audio_samples_size, &audio_samples);
  TF_LITE_MICRO_EXPECT_EQ(kTfLiteOk, get_status);
  TF_LITE_MICRO_EXPECT_LE(audio_samples_size, kMaxAudioSampleSize);
  TF_LITE_MICRO_EXPECT(audio_samples != nullptr);
  ...
  get_status =
      GetAudioSamples(12250, kFeatureSliceDurationMs,
                      &audio_samples_size, &audio_samples);
  TF_LITE_MICRO_EXPECT_EQ(kTfLiteOk, get_status);
  TF_LITE_MICRO_EXPECT_LE(audio_samples_size, kMaxAudioSampleSize);
  TF_LITE_MICRO_EXPECT(audio_samples != nullptr);
